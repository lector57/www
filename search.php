...
<input type=radio name="sp-p" value="any" >любого&nbsp;слова
<input type=radio name="sp-p" value="all" checked>всех&nbsp;слов
...
<tr><td><p>&nbsp;</p></td><td align=right><p>по:</p></td><td><p>
...
<option value="body" selected>текст документов</option>
